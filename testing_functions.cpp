...
namespace rootba_povar {
    ...
    void recoverK_detailed_losses(int num_cams, int num_reconstructions, double translation_range){
        ...
        std::stringstream path;
        path << "/Data/gautt/bundle_adjustment/autocalibration_project/results/RecoverK_detailed_"
             << num_cams << "Cams_"
             << num_reconstructions << "Reconstr_"
             << translation_range << "Transl.txt";
        ...
        for (size_t equivalent_focal_length = 10; equivalent_focal_length < 300; ++equivalent_focal_length){
            ...
            double  averageQR_K_cost = 0, averageQR_focal_cost = 0, averageQR_pp_cost = 0 ,averageQR_skew_cost = 0,
                    averageIAC_K_cost = 0, averageIAC_focal_cost = 0, averageIAC_pp_cost = 0 ,averageIAC_skew_cost = 0;
    ...
    void recoverK_varying_focal_length(int num_cams, int num_reconstructions, double translation_range){
        ...
        // Here we pick the distribution of focal length of the cameras
        const double center = 50, stddev = 25;
        // By using the real dimensions of a full-frame sensor, the focal length is equal to the equivalent focal length
        const double width = 36, height = 24; 
    
        Mat3 K;
        Mat4 H_real;
        double average_K_cost, K_cost, average_focal_cost, focal_cost, average_pp_cost, pp_cost, average_skew_cost, skew_cost;
        FocalLengths_DistributionAndLosses fl(center, stddev);
        ...
        std::stringstream path;
        path << "/Data/gautt/bundle_adjustment/autocalibration_project/results/RecoverK_varying_detailed_"
             << num_cams << "Cams_"
             << num_reconstructions << "Reconstr_"
             << translation_range << "Transl.txt";
